...
var
  T: IDxccTable;
begin
  { LoadFromFile reports the problem and marks the table unloaded rather than
    raising, so callers see an empty table. }
  T := NewTableFromFile(DataDir + 'definitely-not-here.tab');
