...
type
  ...
  private
    function SweepPrefixes(const TableText: string; Len: Integer): string;
  published
...
function TRobustnessTests.SweepPrefixes(const TableText: string; Len: Integer): string;
var
  T: IDxccTable;
  I, J: Integer;
  Prefix: string;
